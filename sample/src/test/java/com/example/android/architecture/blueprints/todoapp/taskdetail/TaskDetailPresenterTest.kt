...
class TaskDetailPresenterTest {
    ...
    @Mock private lateinit var taskDetailView: TaskDetailView
    ...
    @Test fun getActiveTaskFromRepositoryAndLoadIntoView() {
        ...
        taskDetailPresenter = TaskDetailPresenter(taskDetailView).apply { start() }
    ...
    @Test fun deleteTask() {
        ...
        taskDetailPresenter = TaskDetailPresenter(taskDetailView).apply { deleteTask() }
    ...
    @Test fun completeTask() {
        ...
        val task = Task(TITLE_TEST, DESCRIPTION_TEST)
        taskDetailPresenter = TaskDetailPresenter(taskDetailView).apply {
            start()
            completeTask()
        }
    ...
    @Test fun activeTaskIsShownWhenEditing() {
        ...
        taskDetailPresenter = TaskDetailPresenter(taskDetailView).apply { editTask() }
